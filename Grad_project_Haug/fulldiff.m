...
%              updated: 1 May 2014
%  edited by: Katie Byl (14 July 2018) - now uses "symvar" instead of
%  "findsym".
%
%  See also DIFF

%% KB 7/14/18: a flag chooses between using "findsym".
% Look for this variable in the code: bUseSymvar. (it's within a subfunction)
%
% NOTE: "findsym" was used in the original code, but it is becoming 
% obsolete in matlab. Function "symvar" is the newer version. Updated
% code is actually more compact (due to difference in type of variable
% output for symvar, as compared with findsym).
%
% YOU MUST DEFINE bUseSymvar WITHIN THE APPROPRIATE SUBFUNCTION!
% (Defining it here, for example, it would be ignored...)
%% 
